...
# Function to check pam_pwquality settings in /etc/pam.d/common-password
check_pam_pwquality() {
...
echo "Ubuntu Password Complexity Check Script"
echo "---------------------------------------"
...
echo "Password complexity check for Ubuntu completed."
